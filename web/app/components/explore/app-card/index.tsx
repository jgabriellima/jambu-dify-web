...
const AppCard = ({
  ...
  return (
    <div className={cn(s.wrap, 'col-span-1 bg-white border-2 border-solid border-transparent    shadow-sm min-h-[160px] flex flex-col transition-all duration-200 ease-in-out cursor-pointer hover:shadow-lg')}>
