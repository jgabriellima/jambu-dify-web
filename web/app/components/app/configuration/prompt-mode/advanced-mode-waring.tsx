...
const AdvancedModeWarning: FC<Props> = ({
  ...
  if (!show)
    return null
  return (
    <div className='mb-3 py-3 px-4 border border-[#FEF0C7]   bg-[#FFFAEB]' >
      ...
      <div className='flex justify-between items-center'>
        <div className='text-xs leading-[18px] '>
          ...
          <a
            className='font-medium text-[#38A169]'
        ...
        <div className='flex items-center space-x-1'>
          <div
            ...
            className='shrink-0 flex items-center h-6 px-2 bg-indigo-600 shadow-xs border border-gray-200    text-white text-xs font-semibold cursor-pointer space-x-1'
          >
