...
const FeatureItem: FC<IFeatureItemProps> = ({
  ...
  return (
    <div className={cn(s.wrap, 'relative flex justify-between p-3   border border-transparent bg-gray-50 hover:border-gray-200  cursor-pointer')}>
      <div className='flex space-x-3 mr-2'>
        {/* icon */}
        <div
          className='shrink-0 flex items-center justify-center w-8 h-8    border border-gray-200 bg-white'
          style={{
