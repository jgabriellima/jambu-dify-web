...
const APIKeyInfoPanel: FC = () => {
  ...
  return (
    <div className={cn('bg-[#EFF4FF] border-[#D1E0FF]', 'mb-6 relative      shadow-md border  p-8 ')}>
      ...
      {!isCloud && (
        <a
          className='mt-2 flex items-center h-[26px] text-xs  font-medium text-[#38A169] p-1 space-x-1'
