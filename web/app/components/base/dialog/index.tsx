      ...
      <Dialog as="div" className="relative z-40" onClose={close}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex items-center justify-center min-h-full p-4 text-center">
            ...
            >
              <Dialog.Panel className={classNames('w-full max-w-[800px] p-0 overflow-hidden text-left text-gray-900 align-middle transition-all transform bg-white shadow-xl    ', className)}>
                {Boolean(title) && (
                  <Dialog.Title
                    as={titleAs || 'h3'}
