...
const DrawerPlus: FC<Props> = ({
  ...
  return (
    ...
    <Drawer isOpen={isShow} clickOutsideNotOpen={clickOutsideNotOpen} onClose={onHide} footer={null} mask={isMobile || isShowMask} panelClassname={`mt-16 mx-2 sm:mr-2 mb-3 !p-0 ${panelClassName} ${maxWidthClassName}  `}>
      <div
        className={cn(contentClassName, 'w-full flex flex-col bg-white border-[0.5px] border-gray-200   shadow-xl')}
        style={{
          height,
        }}
        ref={ref}
