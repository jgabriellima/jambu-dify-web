...
const ComponentPickerMenuItem: FC<ComponentPickerMenuItemProps> = ({
  ...
  return (
    <div
      ...
      onClick={onClick}>
      <div className='flex items-center justify-center mr-2 w-8 h-8    border border-gray-100'>
        {option.icon}
      </div>
      <div className='grow'>
      ...
      menuRenderFn={(
        ...
        (anchorElementRef.current && options.length)
          ? ReactDOM.createPortal(
            <div className='mt-[25px] p-1 w-[400px] bg-white    border-[0.5px] border-gray-200 shadow-lg'>
